...
public class CareersTest {
    ...
    public void enterSomethingInSearchPositionField() {
        ...
        drivers.forEach(driver -> Util.findElement(driver, By.xpath(xpath)).sendKeys("This search will show no results"));
        Util.timeout();
    }
    ...
    public void assertNoResultsFound() {
        ...
        drivers.forEach(driver ->
                {
                    String result = Util.findElement(driver, By.xpath(xpath)).getText();
